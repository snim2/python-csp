...
def execute(processCount):
    ...
    def accumulator():
        ...
        print (
            "==== Python CSP Single NestedShallow iteration count = " + str(n))
        print (
            "==== Python CSP Single NestedShallow elapse = " + str(elapseTime))
        print (
            "==== Python CSP Single NestedShallow process count = " + str(processCount))
        print ("==== Python CSP Single NestedShallow processor count = " +
