...
def execute(processCount):
    ...
    def accumulator():
        ...
        print (
            "==== Python CSP Multiple NestedShallow iteration count = " + str(n))
        print (
            "==== Python CSP Multiple NestedShallow elapse = " + str(elapseTime))
        print (
            "==== Python CSP Multiple NestedShallow process count = " + str(processCount))
        print ("==== Python CSP Multiple NestedShallow processor count = " +
